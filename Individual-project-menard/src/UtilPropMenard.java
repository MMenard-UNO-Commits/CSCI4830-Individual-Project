...
public class UtilPropMenard {
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/michaelmenard/git/CSCI4830-Individual-Project/Individual-project-menard/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/Individual-project-menard/config.properties";
